...
public class FingerPaint extends GraphicsActivity
        ...
        switch (item.getItemId()) {
            ...
            case SAVE_ID:
            	try 
            	{
	    			...
	    			Log.i(Settings.TAG, "Painted! Saved to " + saveFile);
	...
	protected void onSaveInstanceState(Bundle outState) {
		//saveNote();
		//ImageUtil.saveBitmap(bitmap, targetFile)
	...
	private String setupTargetFile(String savedMediaLocation) {    	
		...
		String path = SaveFileHelper.generateName(savedMediaLocation, "/", "IMG_" + SaveFileHelper.generateDateString(), "PNG");
		return path;
    }
}
