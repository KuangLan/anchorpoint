...
public class TitleEditor extends Activity implements View.OnClickListener {
    ...
    private static final String[] PROJECTION = new String[] {
            NOTES_TABLE.ID.COLUMN_NAME, // 0
            NOTES_TABLE.TITLE.COLUMN_NAME, // 1            
    };
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		*/
        Intent i = getIntent();
        mRowId = i.getLongExtra(Constants.KEY_NOTE_ID, -1);        
        ...
        Notes note = mDAO.getNote(mRowId);
        if (note != null) {
        	mText.setText(note.getTitle());
        }
        
        Log.i(Settings.TAG, "Opened id: " + mRowId);
    ...
    protected void onPause() {
        ...
        mDAO.updateNote(mRowId, NOTES_TABLE.TITLE.COLUMN_NAME, mTitle);        
    }
